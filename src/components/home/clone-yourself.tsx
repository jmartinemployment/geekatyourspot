export default function CloneYourselfSection() {
  return (
    <>
      <section className="w-full bg-[#023059] min-h-screen py-42 lg:hidden">
          ...
          <div className="grid grid-cols-2">
            <div className="col-span-2">
              <h2 className="text-white text-[12vw] sm:text-6xl md:text-7xl leading-[0.95] font-black font-[var(--font-sora)] shadow-text">
                Clone Yourself
                <br />
                <span className="text-[#C83803]">Work 24/7</span>
              </h2>
            </div>
            ...
            <div className="col-span-1 place-content-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-1">
                  <div className="bg-[#03020d] border border-white/10 rounded-sm shadow-box px-5">
                    <p className="text-2xl font-black text-white text-center">
                      3x
                    </p>
                    <p className="ml-2 text-[6px] md:text-xs font-bold text-slate-500 uppercase tracking-widest">
                      Productivity
                    </p>
                  </div>
                </div>
                <div className="col-span-1">
                  <div className="w-full bg-[#C83803] text-white rounded-sm shadow-box text-center">
                    <p className="text-2xl font-black text-center">24/7</p>
                    <p className="text-[6px] md:text-xs font-bold text-orange-200 uppercase tracking-widest text-center">
                      Automated
                    </p>
                  </div>
                </div>
      ...
      <section className="w-full bg-[#023059] min-h-screen hidden lg:block xl:block">
            ...
            <div className="w-full flex justify-center mt-8">
              <div>
                <div className="grid grid-cols-2 gap-4 w-full mx-auto">
                  ...
                  <div className="p-4 md:p-6 lg:p-8 bg-[#C83803] flex flex-col justify-center text-white rounded-sm shadow-box">
