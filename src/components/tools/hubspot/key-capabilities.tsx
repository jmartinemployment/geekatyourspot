        ...
        <div className="grid min-h-screen grid-cols-12 gap-x-4 place-items-center py-5">
          <div className="col-span-7">
            ...
            <ul className="text-md text-white shadow-text list-disc list-outside pl-3 space-y-2 pt-3">
              <li><GlossaryLink slug="marketing-automation">Marketing Automation</GlossaryLink>: HubSpot allows businesses to automate repetitive marketing tasks such as email campaigns,
                social media posting, and <GlossaryLink slug="lead-generation">lead nurturing</GlossaryLink>. This automation not only saves time but also ensures consistency in
              ...
              <li><GlossaryLink slug="analytics">Analytics</GlossaryLink> and Reporting: HubSpot offers robust analytics tools that provide insights into marketing performance,
              ...
              <li>Content Management System (CMS): With HubSpot&#39;s CMS, businesses can create, manage, and optimize their
                website content to improve <GlossaryLink slug="search-engine-optimization">SEO</GlossaryLink> and engage visitors. The CMS is user-friendly and integrates seamlessly with other
                HubSpot tools.</li>
