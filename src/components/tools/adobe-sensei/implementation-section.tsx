        ...
        <div className="container">
          <div className="grid min-h-screen grid-cols-12 gap-x-4 py-5 place-items-center">
            ...
            <div className="col-span-7">
              ...
              <p className="text-md text-white shadow-text pt-3">Personalized Marketing Campaigns: Companies aiming to deliver personalized marketing experiences can use Adobe Sensei to tailor content in real-time, improving customer engagement and satisfaction.</p>
