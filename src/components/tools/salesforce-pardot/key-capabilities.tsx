        ...
        <div className="grid min-h-screen grid-cols-12 gap-x-4 place-items-center py-5">
          <div className="col-span-7">
            ...
            <ul className="text-md text-white shadow-text list-disc list-outside pl-3 space-y-2 pt-3">
              <li>Lead Scoring and Grading: Automatically score leads based on their engagement and fit, allowing sales teams to
              ...
              <li>Email Marketing Automation: Design and send personalized email campaigns with ease. Pardot’s drag-and-drop
                interface and AI-driven insights help craft messages that resonate with recipients, increasing open and
              ...
              <li>Campaign Management: Plan, execute, and analyze marketing campaigns from a single platform. Pardot’s
                comprehensive campaign management tools allow for detailed tracking of campaign performance and ROI.</li>
