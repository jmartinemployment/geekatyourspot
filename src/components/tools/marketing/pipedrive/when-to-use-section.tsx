      ...
      <div className="container">
        <div className="grid min-h-screen grid-cols-12 gap-x-4 lg:place-items-center">
          <div className="col-span-7">
            ...
            <p className="pt-3 text-md font-normal text-white shadow-text">Pipedrive is an excellent choice for small to medium-sized teams looking to enhance their sales process with <GlossaryLink slug="machine-learning" className="text-[#0B162A] hover:underline">AI-powered</GlossaryLink> <GlossaryLink slug="lead-scoring" className="text-[#0B162A] hover:underline">lead scoring</GlossaryLink>. It offers a straightforward interface and robust functionality to prioritize high-potential leads without the overhead of enterprise <GlossaryLink slug="crm" className="text-[#0B162A] hover:underline">CRM</GlossaryLink> suites.</p>
