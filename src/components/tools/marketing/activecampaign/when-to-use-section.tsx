      ...
      <div className="container">
        <div className="grid min-h-screen grid-cols-12 gap-x-4 lg:place-items-center">
          <div className="col-span-7">
            ...
            <p className="pt-3 text-md font-normal text-white shadow-text">ActiveCampaign is ideal when manual <GlossaryLink slug="lead-scoring" className="text-[#0B162A] hover:underline">lead scoring</GlossaryLink> has become a bottleneck. If your sales team spends hours sorting spreadsheets, relies on gut feel to rank prospects, or routinely misses high-potential leads, its <GlossaryLink slug="machine-learning" className="text-[#0B162A] hover:underline">AI</GlossaryLink>-driven automation replaces subjective guesswork with data-backed prioritization and frees reps to engage rather than evaluate.</p>
