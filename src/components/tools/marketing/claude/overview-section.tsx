  ...
  const body = (
    <>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Claude is an <GlossaryLink slug="machine-learning">AI-driven</GlossaryLink> content generation tool designed to streamline the process of creating <GlossaryLink slug="search-engine-optimization">SEO-optimized</GlossaryLink> blogs and articles. In the competitive digital landscape, where small businesses often find themselves overwhelmed by the demands of <GlossaryLink slug="marketing-automation">content creation</GlossaryLink>, Claude offers a solution that reduces time spent on drafting and researching while enhancing content quality. By leveraging AI, Claude helps businesses produce engaging, high-ranking content efficiently.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Many small businesses in areas like Palm Beach and Broward counties face the challenge of producing content that not only engages readers but also ranks well in search engines. Traditional methods of content creation involve extensive <GlossaryLink slug="keyword-density">keyword research</GlossaryLink>, topic brainstorming, and multiple drafts, which can be both time-consuming and error-prone. Claude addresses these pain points by automating much of the labor-intensive work involved in content creation. It allows businesses to focus more on strategy and creativity, rather than getting bogged down by the technical aspects of SEO.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
