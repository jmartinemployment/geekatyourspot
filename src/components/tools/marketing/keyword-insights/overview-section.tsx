  ...
  const body = (
    <>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Keyword Insights is a robust tool designed to streamline the process of <GlossaryLink slug="search-engine-optimization">SEO blog</GlossaryLink> and article generation. For small businesses, particularly those in Palm Beach and Broward counties, the challenge of creating content that ranks well on search engines is significant. Traditional methods often involve labor-intensive tasks such as brainstorming, <GlossaryLink slug="keyword-density">keyword research</GlossaryLink>, and drafting, which can be both time-consuming and prone to human error. Keyword Insights addresses these pain points by automating key aspects of the <GlossaryLink slug="marketing-automation">content creation</GlossaryLink> process, allowing businesses to focus more on strategic elements and creativity.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        With Keyword Insights, businesses can reduce the time spent on content creation while improving the quality and searchability of their content. The tool leverages AI to provide <GlossaryLink slug="analytics">data-driven</GlossaryLink> insights into keyword performance, enabling users to make informed decisions about which keywords to target. This not only helps in crafting content that resonates with target audiences but also enhances the likelihood of achieving higher search engine rankings.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
