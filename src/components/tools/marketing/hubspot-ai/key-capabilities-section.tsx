        ...
        <div className="grid min-h-screen grid-cols-12 gap-x-4 place-items-center">
          <div className="col-span-7">
            ...
            <ul className="list-disc list-outside pl-3 space-y-2 text-md font-normal text-white shadow-text pt-3">
              ...
              <li>Performance Analytics: HubSpot AI provides insights into how your content is performing across various metrics. By tracking engagement rates, traffic, and conversion rates, businesses can make informed decisions on how to adjust their content strategy for better results.</li>
