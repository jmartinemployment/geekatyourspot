  ...
  const body = (
    <>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Surfer SEO is a powerful tool specifically designed to streamline the process of creating <GlossaryLink slug="search-engine-optimization">SEO-optimized</GlossaryLink> blog posts and articles. In the competitive world of digital marketing, where small businesses often find themselves overwhelmed by the demands of <GlossaryLink slug="marketing-automation">content creation</GlossaryLink>, Surfer SEO offers a solution that cuts down on time and effort while enhancing the quality of the output. By leveraging <GlossaryLink slug="machine-learning">AI-driven</GlossaryLink> insights, it helps users generate content that not only ranks well on search engines but also resonates with target audiences.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Surfer SEO excels in transforming the traditional, labor-intensive approach to SEO content creation into a more efficient and effective process. Traditionally, creating SEO-friendly content involves extensive <GlossaryLink slug="keyword-density">keyword research</GlossaryLink>, meticulous drafting, and constant updates to keep up with search engine algorithm changes. This process is not only time-consuming but also prone to human error, leading to missed opportunities and wasted resources. Surfer SEO addresses these challenges by automating much of the research and analysis, allowing users to focus more on strategy and creativity.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
