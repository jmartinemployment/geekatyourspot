  ...
  const body = (
    <>
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Surfer SEO is equipped with a variety of features that make it a standout tool for SEO blog and article generation. Its capabilities are tailored to help users create content that is not only engaging but also optimized for search engines.
      </p>
      <ul className="list-disc list-outside pl-3 space-y-2 text-md font-normal text-white shadow-text pt-3">
        ...
        <li>Keyword Research: Surfer SEO provides robust keyword research capabilities, enabling users to identify high-potential keywords that can drive traffic and engagement. The tool offers insights into search volume, keyword difficulty, and related queries.</li>
