      ...
      <div className="container">
        <div className="grid min-h-screen grid-cols-12 gap-x-4 place-items-center">
          <div className="col-span-7">
            ...
            <p className="pt-3 text-md font-normal text-white shadow-text">Airia is equipped with a range of features designed to enhance <GlossaryLink slug="content-repurposing">content repurposing</GlossaryLink> efforts. These capabilities make it a versatile tool for businesses aiming to extend the lifespan of their content while maintaining quality and consistency.</p>
