        ...
        <div className="container">
          <div className="grid min-h-screen grid-cols-12 gap-x-4">
            ...
            <div className="col-span-12">
              ...
              <p className="text-md text-white shadow-text pt-3">Traditional ad management often suffers from data inconsistencies and inaccuracies, leading to ineffective ad spend.
                Qualytics addresses these issues by automating data quality checks and validations. This ensures that the data used
                in platforms like Google Ads Smart Bidding is accurate and reliable, allowing for more precise bid adjustments and
              ...
              <p className="text-md text-white shadow-text pt-3">Qualytics provides a robust framework for data validation, anomaly detection, and data governance. This ensures that
                ...
                in happier customers and a more efficient use of marketing budgets.</p>
            </div>
          </div>
        </div>
      </section>
