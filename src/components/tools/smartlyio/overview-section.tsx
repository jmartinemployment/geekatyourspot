          ...
          <div className="grid min-h-screen grid-cols-12 gap-x-4">
            ...
            <div className="col-span-12">
              ...
              <p className="text-md text-white shadow-text pt-3">Smartly.io also integrates seamlessly with other marketing tools such as HubSpot and Salesforce Einstein, allowing
                ...
                facilitates the flow of data between systems, ensuring that insights gained from ad performance can inform broader
                marketing strategies and vice versa.</p>
              <p className="text-md text-white shadow-text pt-3">For businesses in Palm Beach and Broward counties, where market competition is fierce, Smartly.io offers a strategic
                advantage by minimizing guesswork and maximizing ad performance. By leveraging Smartly.io, companies can focus more
                on strategic planning and less on the minutiae of ad management. This shift not only saves time but also enhances
                the overall effectiveness of marketing campaigns, leading to increased sales and customer satisfaction.</p>
            </div>
          </div>
        </div>
      </section>
