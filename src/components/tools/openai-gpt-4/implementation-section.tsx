        ...
        <div className="container">
          <div className="grid min-h-screen grid-cols-12 gap-x-4 py-5 place-items-center">
            ...
            <div className="col-span-7">
              ...
              <p className="text-md text-white shadow-text pt-3">While GPT-4 is primarily a configuration-based tool, it offers an <GlossaryLink slug="api">API</GlossaryLink> that allows for further customization and integration into bespoke applications. This flexibility can be leveraged to extend the tool&#39;s capabilities and tailor it to specific business requirements.</p>
