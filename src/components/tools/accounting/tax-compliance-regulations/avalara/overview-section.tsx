export default function OverviewToolSection() {
  const body = (
    <>
      <p className="text-md text-white shadow-text pt-3">Avalara is a comprehensive tax compliance software designed to streamline tax processes for businesses of all sizes. This tool is particularly valuable for organizations managing complex tax requirements across multiple jurisdictions. By automating tax calculations, compliance tracking, and reporting, Avalara significantly reduces the time and resources required for tax management.</p>
