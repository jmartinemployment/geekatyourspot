          ...
          <div className="grid min-h-screen grid-cols-12 gap-x-4 py-5">
            ...
            <div className="col-span-12">
              ...
              <p className="text-md text-white shadow-text pt-3">1. Accelerated Deployment: Basis Technologies offers pre-built connectors and templated setups that facilitate a
                quicker go-live process. These resources help streamline the initial setup phase, reducing the time and effort
                required to integrate the platform with existing marketing systems. For businesses looking to rapidly deploy the
                solution, leveraging these pre-built tools can significantly shorten the timeline.</p>
              ...
              <p className="text-md text-white shadow-text pt-3">4. Custom Code/Development: While Basis Technologies primarily operates through configuration, it also provides APIs
                for custom development where needed. This allows businesses to extend the platform’s capabilities to meet unique
                requirements. For those with specific needs that go beyond standard configurations, utilizing these APIs can provide
                the necessary flexibility.</p>
              <p className="text-md text-white shadow-text pt-3">At Geek At Your Spot, we specialize in closing the gap for businesses by providing expert guidance in these areas.
                Our consultative approach ensures that the implementation of Basis Technologies is aligned with your business goals,
                enabling you to fully leverage its capabilities for automated ad spend optimization.</p>
            </div>
          </div>
        </div >
      </section >
