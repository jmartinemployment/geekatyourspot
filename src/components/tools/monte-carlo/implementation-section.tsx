            ...
            <div className="col-span-12">
              ...
              <ul className="text-md text-white shadow-text list-disc list-outside pl-3 space-y-2 pt-3">
                <li>Accelerated Deployment: Monte Carlo offers pre-built connectors and templated setups that significantly
                  ...
                  into their existing systems, reducing the time to go-live and allowing for faster realization of benefits.</li>
                <li>Data Model Design: An effective data model is crucial for maximizing Monte Carlo’s capabilities. This
                  involves mapping out data flows and ensuring that data is structured in a way that supports observability.
                  Geek At Your Spot can assist in designing a data model that aligns with your business goals and optimizes ad
                  spend.</li>
                <li>Workflow/Process Configuration: Monte Carlo requires configuration of workflows to automate data monitoring
                  and anomaly detection. Setting up approval chains and routing rules ensures that the right stakeholders are
