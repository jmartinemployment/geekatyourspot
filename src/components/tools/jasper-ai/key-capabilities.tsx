        ...
        <div className="grid min-h-screen grid-cols-12 gap-x-4 place-items-center py-5">
          <div className="col-span-7">
            <h2 className="text-white lg:text-[3.5rem] font-black font-[var(--font-sora)] shadow-text">
              Key Capabilities</h2>
            <p className="text-md text-white shadow-text pt-3">Jasper AI offers a suite of capabilities that make it a standout tool in the realm of automated <GlossaryLink slug="marketing-automation">content creation</GlossaryLink>.
            ...
            <ul className="text-md text-white shadow-text list-disc list-outside pl-3 space-y-2 pt-3">
              <li><GlossaryLink slug="machine-learning">AI-Powered</GlossaryLink> Content Generation: Jasper AI uses advanced algorithms to generate content that aligns with user
              ...
              <li><GlossaryLink slug="search-engine-optimization">SEO</GlossaryLink> Optimization: Jasper AI assists in optimizing content for search engines, helping businesses improve their
              ...
              <li>Performance Analytics: Jasper AI provides insights into content performance, helping users understand what works
                and what doesn&apos;t, and allowing for <GlossaryLink slug="analytics">data-driven</GlossaryLink> improvements.</li>
            </ul>
