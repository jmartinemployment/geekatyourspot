          ...
          <div className="grid min-h-screen grid-cols-12 gap-x-4">
            ...
            <div className="col-span-12">
              ...
              <p className="text-md text-white shadow-text pt-3">Canva offers a wide range of templates and design elements that users can customize to fit their specific needs.
                This flexibility ensures that businesses can maintain consistency in their branding while adapting to various
                marketing and communication requirements. The platform supports a variety of content types, including social media
                graphics, presentations, posters, and more, making it a comprehensive tool for creating diverse visual materials.
              </p>
              <p className="text-md text-white shadow-text pt-3">One of Canva&#39;s key strengths is its ability to integrate with other tools and platforms, allowing for seamless
                content sharing and collaboration. Teams can work together in real-time, making it easier to manage projects and
