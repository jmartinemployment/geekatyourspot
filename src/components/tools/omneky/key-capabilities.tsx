            ...
            <div className="col-span-12">
              ...
              <ul className="text-md text-white shadow-text list-disc list-outside pl-3 space-y-2 pt-3">
                ...
                <li>Audience Insights: The platform provides detailed insights into audience demographics and behavior patterns,
                  enabling marketers to tailor their campaigns more precisely. These insights help in identifying high-value
                  segments and optimizing content for better engagement.</li>
                ...
                <li>Budget Management: Omneky provides tools for effective budget allocation, allowing businesses to set
                  ...
                  resources are directed towards the most promising opportunities.</li>
              </ul>
              <p className="text-md text-white shadow-text pt-3">These capabilities make Omneky a comprehensive solution for businesses looking to automate and optimize their ad
                spend. By reducing manual workload and enhancing decision-making, Omneky enables marketers to focus on strategic
                initiatives that drive growth.</p>
            </div>
          </div>
        </div>
      </section>
