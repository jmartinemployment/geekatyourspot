          ...
          <div className="grid min-h-screen grid-cols-12 gap-x-4">
            ...
            <div className="col-span-12">
              ...
              <p className="text-md text-white shadow-text pt-3">The platform integrates with other tools such as Google Ads Smart Bidding, providing a comprehensive solution for ad
                ...
                down on wasted ad spend and focus on strategies that drive tangible results. This integration allows for dynamic bid
                adjustments, ensuring ads reach the right audience at the right time.</p>
              <p className="text-md text-white shadow-text pt-3">At Geek At Your Spot, we specialize in helping businesses implement Salesforce Einstein for automated ad spend
                optimization. Our approach ensures accelerated deployment and smooth integration with your existing systems,
                allowing you to quickly benefit from AI-driven insights. This guidance is particularly valuable in regions where
                businesses face the challenge of managing complex marketing data and achieving consistent results.</p>
            </div>
          </div>
        </div>
      </section>
