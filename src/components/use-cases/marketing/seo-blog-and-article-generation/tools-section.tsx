  ...
  const body = (
    <>
      ...
      <ul className="list-disc list-outside pl-3 space-y-2 text-md font-normal text-white shadow-text pt-3">
        <li><Link id="tools-marketing-chatgpt-4" href="/tools/marketing/chatgpt" className="text-[#0B162A] hover:underline">ChatGPT</Link>: Known for its <GlossaryLink slug="natural-language-processing" className="text-[#0B162A] hover:underline">natural language processing</GlossaryLink> capabilities, ChatGPT excels at generating human-like text. By training on a diverse range of topics, it assists in creating articles that resonate with target audiences. This tool is particularly useful for drafting engaging introductions and conclusions.</li>
        <li><Link id="tools-marketing-surfer-seo-4" href="/tools/marketing/surfer-seo" className="text-[#0B162A] hover:underline">Surfer SEO</Link>: This tool combines AI with SEO optimization, ensuring that every piece of content is not just well-written but also ranks well. Surfer SEO provides data-driven insights into <GlossaryLink slug="keyword-density" className="text-[#0B162A] hover:underline">keyword density</GlossaryLink>, structure, and readability, making it a comprehensive solution for content creators aiming to improve their search engine rankings.</li>
        <li><Link id="tools-marketing-frase-3" href="/tools/marketing/frase" className="text-[#0B162A] hover:underline">Frase</Link>: Frase focuses on content briefs and topic research. It helps in identifying gaps in existing content and suggests how to fill them with new articles. By analyzing top-performing articles in a niche, it provides recommendations that help in crafting content that meets user intent.</li>
        <li><Link id="tools-marketing-claude-2" href="/tools/marketing/claude" className="text-[#0B162A] hover:underline">Claude</Link>: This tool offers advanced text generation and editing features, allowing users to refine the tone and style of their content. Claude is particularly effective for creating more nuanced content that requires a deeper understanding of context and subtleties in language.</li>
        <li><Link id="tools-marketing-hubspot-ai-2" href="/tools/marketing/hubspot-ai" className="text-[#0B162A] hover:underline">HubSpot AI</Link>: Part of the broader HubSpot ecosystem, this AI assists in refining marketing strategies by generating personalized content. It integrates seamlessly with HubSpot&apos;s <GlossaryLink slug="crm" className="text-[#0B162A] hover:underline">CRM</GlossaryLink>, allowing for targeted content creation that aligns with customer data.</li>
      </ul>
      <p className="pt-3 text-md font-normal text-white shadow-text">
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Seamless integration with existing workflows is vital for maximizing the benefits of AI tools. HubSpot AI, for instance, integrates with <GlossaryLink slug="crm" className="text-[#0B162A] hover:underline">CRM</GlossaryLink> systems, allowing for personalized content generation based on customer insights. This ensures that the content not only engages but also converts.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
