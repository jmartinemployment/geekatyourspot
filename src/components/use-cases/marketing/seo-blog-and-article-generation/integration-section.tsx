...
export default function IntegrationSection() {
  const body = (
    <>
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Effectively planning content requires more than intuition; it demands data-driven insights. Tools like <Link id="tools-marketing-frase-4" href="/tools/marketing/frase" className="text-[#C83803] hover:underline">Frase</Link> provide detailed analyses of current content landscapes, helping businesses identify gaps and opportunities for new content. This ensures that your content calendar is filled with strategic, impactful topics.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">
        Engaging content is essential for retaining your audience and encouraging interaction. AI tools like <Link id="tools-marketing-chatgpt-5" href="/tools/marketing/chatgpt" className="text-[#C83803] hover:underline">ChatGPT</Link> can craft personalized content that speaks directly to the interests and needs of your audience, enhancing engagement and building brand loyalty.
      </p>
      <p className="pt-3 text-md font-normal text-white shadow-text">
