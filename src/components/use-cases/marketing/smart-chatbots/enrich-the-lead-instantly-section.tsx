...
export default function EnrichTheLeadInstantlySection() {
  const body = (
    <>
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">AI integration in lead enrichment processes allows businesses to extract more value from each interaction. By using AI-powered chatbots, you can automate the collection of data such as customer preferences, behavioral patterns, and purchase intent. This data then feeds into your CRM, creating a comprehensive profile for every lead.</p>
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">With enriched lead data, sales teams can quickly identify the most promising leads, reducing the time spent on unqualified prospects. By incorporating lead enrichment into your workflow with tools like <Link href="/tools/marketing/pipedrive" className="text-[#0B162A] hover:underline">Pipedrive</Link>, you can set up a multi-touch cadence that integrates enriched data into your lead management process. This efficiency boost allows for more strategic allocation of resources, ultimately driving higher conversion rates.</p>
    </>
  );
