...
export default function LedeSection() {
  const body = (
    <>
      <p className="pt-3 text-md font-normal text-white shadow-text">In the fast-paced world of digital marketing, the biggest challenge many businesses face is the lag between lead generation and lead engagement. Delays in responding to potential customers can lead to lost opportunities, decreased conversions, and ultimately, lower sales. With customers expecting rapid responses, businesses that fail to engage leads quickly risk falling behind.</p>
      <p className="pt-3 text-md font-normal text-white shadow-text">Smart chatbots for marketing offer a solution by automating initial interactions, ensuring that leads are acknowledged and engaged immediately. This can dramatically reduce the gap between lead capture and engagement, which is crucial for maintaining interest and increasing conversion rates. Companies like <Link href="/tools/marketing/bot-penguin" className="text-[#C83803] hover:underline">BotPenguin</Link> provide no-code AI chatbot solutions that work across various platforms such as WhatsApp, Instagram, and Facebook, making it easy for businesses to connect with potential customers at any time, without manual intervention.</p>
          ...
          <div className="grid min-h-screen grid-cols-12 gap-x-4 place-items-center">
            ...
            <div className="col-span-7">
              <h2 className="text-white text-[6vw] sm:text-4xl md:text-5xl leading-[0.95] font-black font-[var(--font-sora)] shadow-text" id="the-core-problem">
                The Core Problem: Speed to Lead
              </h2>
            </div>
