...
export default function CaptureOnEveryChannelSection() {
  const body = (
    <>
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">Smart chatbots offer a solution by enabling businesses to engage with customers on every major platform seamlessly. <Link href="/tools/marketing/bot-penguin" className="text-[#C83803] hover:underline">BotPenguin</Link>, for instance, allows companies to deploy no-code AI chatbots on websites, WhatsApp, Instagram, Facebook, and Telegram. This ensures that every interaction is captured, regardless of where it starts. By using a single platform to manage multiple channels, businesses can maintain consistent communication without the need for extensive manual oversight.</p>
      <h3 className="text-white pt-2 text-[5vw] sm:text-3xl lg:text-3xl leading-[0.95] font-black font-[var(--font-sora)] shadow-text" id="optimizing-multi-channel">Optimizing Multi-Channel Engagement</h3>
      ...
      <h3 className="text-white pt-2 text-[5vw] sm:text-3xl lg:text-3xl leading-[0.95] font-black font-[var(--font-sora)] shadow-text" id="seamless-crm-integration">Seamless CRM Integration</h3>
      ...
      <p className="pt-3 text-md font-normal text-white shadow-text">Chatbots ensure that businesses are available to customers around the clock, providing immediate assistance and information. This constant availability can significantly enhance customer satisfaction and trust.</p>
    </>
  );
