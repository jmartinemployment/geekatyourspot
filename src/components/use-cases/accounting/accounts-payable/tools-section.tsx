        ...
        <div className="container">
          <div className="grid min-h-screen grid-cols-12 gap-x-4 py-5">
            ...
            <div className="col-span-6">
              ...
              <p className="pt-5 text-md font-normal text-white shadow-text-orange">Tipalti is a comprehensive payables automation solution that streamlines the end-to-end AP process. It offers
              ...
              <h4 className="text-white pt-2 lg:text-2xl font-black font-[var(--font-sora)] shadow-text-orange">
                How an AI implementer helps with Tipalti</h4>
              <p className="pt-5 text-md font-normal text-white shadow-text-orange">
                Geek At Your Spot accelerates deployment with Tipalti by leveraging its pre-built integration capabilities,
              ...
              <h4 className="text-white pt-2 lg:text-2xl font-black font-[var(--font-sora)] shadow-text-orange">How an AI implementer helps with Basware</h4>
              <p className="pt-5 text-md font-normal text-white shadow-text-orange">With Basware, Geek At Your Spot speeds up deployment using its cloud-based architecture, allowing for quick
            ...
            <div className="col-span-6">
              ...
              <h4 className="text-white pt-2 lg:text-2xl font-black font-[var(--font-sora)] shadow-text-orange">How an AI implementer helps with Rillion</h4>
              <p className="pt-5 text-md font-normal text-white shadow-text-orange">Geek At Your Spot facilitates accelerated Rillion deployment through its rapid setup capabilities and
