...
const PAGE_DESCRIPTION =
  "Explore accounting and financial automation tools that Geek at Your Spot helps South Florida small businesses implement — from tax compliance to accounts payable automation.";
...
export default function AccountingToolsPage() {
  const tools = getToolsByDepartment("accounting").sort((a, b) =>
    ...
    <div className="bg-[rgb(2,48,89)] text-white">
      ...
      <section className="container py-16 lg:py-24">
        ...
        <p className="pt-5 max-w-3xl text-xl text-white shadow-text lg:text-2xl">
          Automate your accounting and financial operations with the platforms
          we help South Florida small businesses implement — from tax
          compliance to accounts payable automation.
        </p>
